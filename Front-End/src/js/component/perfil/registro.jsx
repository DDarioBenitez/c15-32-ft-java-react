            ...
            >
                ...
                <form className="form-logIn form-register" onSubmit={onFormSubmit} noValidate>
                    <div className="mb-3">
                        ...
                        <input className="form-control " type="text" id="email" name="email" onChange={e => setEmail(e.target.value)} placeholder="INGRESA TU CORREO: ejemplo@email.com" required />
                    </div>
                    ...
                    <div className="mb-3">
                        {/* <label className="form-label" htmlFor="password">Contraseña</label> */}
                        <input className="form-control " type="text" id="nombre" name="nombre" placeholder="NOMBRE" onChange={e => setNombre(e.target.value)} required />
                    </div>

                    <div className="mb-3">
                        {/* <label className="form-label" htmlFor="password">Contraseña</label> */}
                        <input className="form-control" type="text" id="apellido" name="apellido" placeholder="APELLIDO" onChange={e => setApellido(e.target.value)} required />
                    </div>

                    <div className="mb-3">
                        {/* <label className="form-label" htmlFor="password">Contraseña</label> */}
                        <input className="form-control" type="tel" id="telefono" name="telefono" placeholder="TELEFONO" onChange={e => setTelefono(e.target.value)} required />
                    </div>
